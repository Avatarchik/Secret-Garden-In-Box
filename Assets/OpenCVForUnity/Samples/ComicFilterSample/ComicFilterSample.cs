...
//								rgbaMat = new Mat (webCamTexture.height, webCamTexture.width, CvType.CV_8UC4);
                ...
                laplacMat = new Mat(webCamTexture.height, webCamTexture.width, CvType.CV_32F);
...
//				Imgproc.cvtColor (rgbaMat, grayMat, Imgproc.COLOR_RGBA2GRAY);
            ...
            //Imgproc.medianBlur(grayMat, lineMat, 7);
            ...
            /*Imgproc.Laplacian(lineMat, laplacMat, 3);
            Core.MinMaxLocResult res = Core.minMaxLoc(laplacMat);
            double scale = 127 / Math.Max(-res.minVal, res.maxVal);
            Mat laplacianImage = new Mat();
            laplacMat.convertTo(laplacianImage, CvType.CV_8U, scale, 128);*/
