...
//	}
		...
		// C++:  Point2f Subdiv2D::getVertex(int vertex, int* firstEdge = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void imgproc_Subdiv2D_getVertex_10(IntPtr nativeObj, int vertex, double[] firstEdge_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void imgproc_Subdiv2D_getVertex_11(IntPtr nativeObj, int vertex,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
