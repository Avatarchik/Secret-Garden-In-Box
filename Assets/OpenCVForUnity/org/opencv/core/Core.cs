...
namespace OpenCVForUnity
{
		public class Core
		{
				...
				public static readonly int VERSION_EPOCH = getVersionEpoch ();
...
//		MAGIC_MASK = 0xFFFF0000,
						...
						FONT_ITALIC = 16;
				public const uint MAGIC_MASK = 0xFFFF0000;//TODO:@check
 ...
 */
			...
			core_Core_LUT_10(src.nativeObj, lut.nativeObj, dst.nativeObj, interpolation);
 ...
 */
				public static void LUT (Mat src, Mat lut, Mat dst)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_LUT_11(src.nativeObj, lut.nativeObj, dst.nativeObj);
 ...
 */
		...
		return;
				...
				public static void PCAComputeVar (Mat data, Mat mean, Mat eigenvectors, double retainedVariance)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_PCAComputeVar_10(data.nativeObj, mean.nativeObj, eigenvectors.nativeObj, retainedVariance);
 ...
 */
				public static void arrowedLine (Mat img, Point pt1, Point pt2, Scalar color, int thickness, int line_type, int shift, double tipLength)
				{
						...
						core_Core_arrowedLine_10 (img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val [0], color.val [1], color.val [2], color.val [3], thickness, line_type, shift, tipLength);
 ...
 */
				public static void arrowedLine (Mat img, Point pt1, Point pt2, Scalar color)
				{
						...
						core_Core_arrowedLine_11 (img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val [0], color.val [1], color.val [2], color.val [3]);
 ...
 */
				public static void circle (Mat img, Point center, int radius, Scalar color, int thickness, int lineType, int shift)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_circle_10(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
 ...
 */
				public static void circle (Mat img, Point center, int radius, Scalar color, int thickness)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_circle_11(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
 ...
 */
				public static void circle (Mat img, Point center, int radius, Scalar color)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_circle_12(img.nativeObj, center.x, center.y, radius, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
		...
		double[] pt2_out = new double[2];
			bool retVal = core_Core_clipLine_10(imgRect.x, imgRect.y, imgRect.width, imgRect.height, pt1.x, pt1.y, pt1_out, pt2.x, pt2.y, pt2_out);
 ...
 */
				public static bool eigen (Mat src, bool computeEigenvectors, Mat eigenvalues, Mat eigenvectors)
				{
						if (src != null)
								src.ThrowIfDisposed ();
						if (eigenvalues != null)
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			bool retVal = core_Core_eigen_10(src.nativeObj, computeEigenvectors, eigenvalues.nativeObj, eigenvectors.nativeObj);
 ...
 */
				public static void ellipse (Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness, int lineType, int shift)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_ellipse_10(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
 ...
 */
				public static void ellipse (Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_ellipse_11(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
 ...
 */
				public static void ellipse (Mat img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_ellipse_12(img.nativeObj, center.x, center.y, axes.width, axes.height, angle, startAngle, endAngle, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
				public static void ellipse (Mat img, RotatedRect box, Scalar color, int thickness, int lineType)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_ellipse_13(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
 ...
 */
				public static void ellipse (Mat img, RotatedRect box, Scalar color, int thickness)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_ellipse_14(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
 ...
 */
				public static void ellipse (Mat img, RotatedRect box, Scalar color)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_ellipse_15(img.nativeObj, box.center.x, box.center.y, box.size.width, box.size.height, box.angle, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
				public static void ellipse2Poly (Point center, Size axes, int angle, int arcStart, int arcEnd, int delta, MatOfPoint pts)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
		Mat pts_mat = pts;
			core_Core_ellipse2Poly_10(center.x, center.y, axes.width, axes.height, angle, arcStart, arcEnd, delta, pts_mat.nativeObj);
 ...
 */
		...
		Mat points_mat = points;
			core_Core_fillConvexPoly_10(img.nativeObj, points_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType, shift);
 ...
 */
				public static void fillConvexPoly (Mat img, MatOfPoint points, Scalar color)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
		Mat points_mat = points;
			core_Core_fillConvexPoly_11(img.nativeObj, points_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
		...
		Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
			core_Core_fillPoly_10(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3], lineType, shift, offset.x, offset.y);
 ...
 */
		...
		List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
		Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
			core_Core_fillPoly_11(img.nativeObj, pts_mat.nativeObj, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
				public static void gemm (Mat src1, Mat src2, double alpha, Mat src3, double gamma, Mat dst)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_gemm_11(src1.nativeObj, src2.nativeObj, alpha, src3.nativeObj, gamma, dst.nativeObj);
 ...
 */
				public static void line (Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_line_10(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
 ...
 */
				public static void line (Mat img, Point pt1, Point pt2, Scalar color, int thickness)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_line_11(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
 ...
 */
				public static void line (Mat img, Point pt1, Point pt2, Scalar color)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_line_12(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
		...
		List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
		Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
			core_Core_polylines_10(img.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
 ...
 */
		...
		List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
		Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
			core_Core_polylines_11(img.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
 ...
 */
		...
		List<Mat> pts_tmplm = new List<Mat>((pts != null) ? pts.Count : 0);
		Mat pts_mat = Converters.vector_vector_Point_to_Mat(pts, pts_tmplm);
			core_Core_polylines_12(img.nativeObj, pts_mat.nativeObj, isClosed, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
				public static void putText (Mat img, string text, Point org, int fontFace, double fontScale, Scalar color, int thickness, int lineType, bool bottomLeftOrigin)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_putText_10(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, bottomLeftOrigin);
 ...
 */
				public static void putText (Mat img, string text, Point org, int fontFace, double fontScale, Scalar color, int thickness)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_putText_11(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
 ...
 */
				public static void putText (Mat img, string text, Point org, int fontFace, double fontScale, Scalar color)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_putText_12(img.nativeObj, text, org.x, org.y, fontFace, fontScale, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 */
				public static void rectangle (Mat img, Point pt1, Point pt2, Scalar color, int thickness, int lineType, int shift)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_rectangle_10(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType, shift);
 ...
 */
				public static void rectangle (Mat img, Point pt1, Point pt2, Scalar color, int thickness)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_rectangle_11(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3], thickness);
 ...
 */
				public static void rectangle (Mat img, Point pt1, Point pt2, Scalar color)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			core_Core_rectangle_12(img.nativeObj, pt1.x, pt1.y, pt2.x, pt2.y, color.val[0], color.val[1], color.val[2], color.val[3]);
 ...
 * <p>int thickness = 3;</p>
 *
 * <p>Mat img(600, 800, CV_8UC3, Scalar.
 * <p>int baseline=0;</p>
 *
 ...
 */
		...
		if(baseLine != null && baseLine.Length != 1)
			...
			core_Core_n_1getTextSize(text, fontFace, fontScale, thickness, baseLine,tmpArray);
		...
		private static extern void core_Core_LUT_10(IntPtr src_nativeObj, IntPtr lut_nativeObj, IntPtr dst_nativeObj, int interpolation);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_LUT_11(IntPtr src_nativeObj, IntPtr lut_nativeObj, IntPtr dst_nativeObj);
		...
		// C++:  void PCAComputeVar(Mat data, Mat& mean, Mat& eigenvectors, double retainedVariance)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_PCAComputeVar_10(IntPtr data_nativeObj, IntPtr mean_nativeObj, IntPtr eigenvectors_nativeObj, double retainedVariance);
		...
		// C++:  void arrowedLine(Mat& img, Point pt1, Point pt2, Scalar color, int thickness = 1, int line_type = 8, int shift = 0, double tipLength = 0.1)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_arrowedLine_10(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int line_type, int shift, double tipLength);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_arrowedLine_11(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);
		...
		// C++:  void circle(Mat& img, Point center, int radius, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_circle_10(IntPtr img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_circle_11(IntPtr img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_circle_12(IntPtr img_nativeObj, double center_x, double center_y, int radius, double color_val0, double color_val1, double color_val2, double color_val3);
		
		// C++:  bool clipLine(Rect imgRect, Point& pt1, Point& pt2)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern bool core_Core_clipLine_10(int imgRect_x, int imgRect_y, int imgRect_width, int imgRect_height, double pt1_x, double pt1_y, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] pt1_out, double pt2_x, double pt2_y, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] pt2_out);
		...
		// C++:  bool eigen(Mat src, bool computeEigenvectors, Mat& eigenvalues, Mat& eigenvectors)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern bool core_Core_eigen_10(IntPtr src_nativeObj, bool computeEigenvectors, IntPtr eigenvalues_nativeObj, IntPtr eigenvectors_nativeObj);
		
		// C++:  void ellipse(Mat& img, Point center, Size axes, double angle, double startAngle, double endAngle, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_ellipse_10(IntPtr img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_ellipse_11(IntPtr img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_ellipse_12(IntPtr img_nativeObj, double center_x, double center_y, double axes_width, double axes_height, double angle, double startAngle, double endAngle, double color_val0, double color_val1, double color_val2, double color_val3);
		
		// C++:  void ellipse(Mat& img, RotatedRect box, Scalar color, int thickness = 1, int lineType = 8)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_ellipse_13(IntPtr img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_ellipse_14(IntPtr img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_ellipse_15(IntPtr img_nativeObj, double box_center_x, double box_center_y, double box_size_width, double box_size_height, double box_angle, double color_val0, double color_val1, double color_val2, double color_val3);
		
		// C++:  void ellipse2Poly(Point center, Size axes, int angle, int arcStart, int arcEnd, int delta, vector_Point& pts)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_ellipse2Poly_10(double center_x, double center_y, double axes_width, double axes_height, int angle, int arcStart, int arcEnd, int delta, IntPtr pts_mat_nativeObj);
		...
		// C++:  void fillConvexPoly(Mat& img, vector_Point points, Scalar color, int lineType = 8, int shift = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_fillConvexPoly_10(IntPtr img_nativeObj, IntPtr points_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType, int shift);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_fillConvexPoly_11(IntPtr img_nativeObj, IntPtr points_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3);
		
		// C++:  void fillPoly(Mat& img, vector_vector_Point pts, Scalar color, int lineType = 8, int shift = 0, Point offset = Point())
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_fillPoly_10(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3, int lineType, int shift, double offset_x, double offset_y);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_fillPoly_11(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, double color_val0, double color_val1, double color_val2, double color_val3);
		...
		// C++:  void line(Mat& img, Point pt1, Point pt2, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_line_10(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_line_11(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_line_12(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);
		...
		// C++:  Scalar mean(Mat src, Mat mask = Mat())
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_mean_10(IntPtr src_nativeObj, IntPtr mask_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_mean_11(IntPtr src_nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals );
		...
		// C++:  void polylines(Mat& img, vector_vector_Point pts, bool isClosed, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_polylines_10(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, bool isClosed, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_polylines_11(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, bool isClosed, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_polylines_12(IntPtr img_nativeObj, IntPtr pts_mat_nativeObj, bool isClosed, double color_val0, double color_val1, double color_val2, double color_val3);
		...
		// C++:  void putText(Mat img, string text, Point org, int fontFace, double fontScale, Scalar color, int thickness = 1, int lineType = 8, bool bottomLeftOrigin = false)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_putText_10(IntPtr img_nativeObj, string text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, bool bottomLeftOrigin);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_putText_11(IntPtr img_nativeObj, string text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_putText_12(IntPtr img_nativeObj, string text, double org_x, double org_y, int fontFace, double fontScale, double color_val0, double color_val1, double color_val2, double color_val3);
		...
		// C++:  void rectangle(Mat& img, Point pt1, Point pt2, Scalar color, int thickness = 1, int lineType = 8, int shift = 0)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_rectangle_10(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness, int lineType, int shift);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_rectangle_11(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3, int thickness);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_rectangle_12(IntPtr img_nativeObj, double pt1_x, double pt1_y, double pt2_x, double pt2_y, double color_val0, double color_val1, double color_val2, double color_val3);
		...
		// C++:  Scalar sum(Mat src)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_sumElems_10(IntPtr src_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals );
		
		// C++:  Scalar trace(Mat mtx)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_trace_10(IntPtr mtx_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals );
		...
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_n_1minMaxLocManual(IntPtr src_nativeObj, IntPtr mask_nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Core_n_1getTextSize(string text, int fontFace, double fontScale, int thickness, [In, Out, MarshalAs(UnmanagedType.LPArray)] int[] baseLine, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
