...
//	
		...
		// C++: void Mat::locateROI(Size wholeSize, Point ofs)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void core_Mat_locateROI_10 (IntPtr nativeObj, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] wholeSize_out, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] ofs_out);
		...
		private static extern void core_Mat_n_1size (IntPtr nativeObj,
		                                            [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		...
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nPutD (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] double[] data);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nPutF (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] float[] data);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nPutI (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] int[] data);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nPutS (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] short[] data);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nPutB (IntPtr self, int row, int col, int count, [In, MarshalAs(UnmanagedType.LPArray)] byte[] data);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nGetB (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] byte[] vals);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nGetS (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] short[] vals);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nGetI (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] int[] vals);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nGetF (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] float[] vals);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nGetD (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern int core_Mat_nGet (IntPtr self, int row, int col, int count, [In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
