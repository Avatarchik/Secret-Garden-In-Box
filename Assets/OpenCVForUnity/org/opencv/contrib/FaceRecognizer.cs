			...
			try {
				...
				if (IsEnabledDispose) {
					if (nativeObj != IntPtr.Zero)
						contrib_FaceRecognizer_delete(nativeObj);
 ...
 */
				...
				{
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			contrib_FaceRecognizer_load_10(nativeObj, filename);
 ...
 */
		...
		double[] confidence_out = new double[1];
			contrib_FaceRecognizer_predict_10(nativeObj, src.nativeObj, label_out, confidence_out);
 ...
 */
				public  void save (string filename)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			contrib_FaceRecognizer_save_10(nativeObj, filename);
 ...
 */
				public  void update (List<Mat> src, Mat labels)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
		Mat src_mat = Converters.vector_Mat_to_Mat(src);
			contrib_FaceRecognizer_update_10(nativeObj, src_mat.nativeObj, labels.nativeObj);
...
//	}
		...
		private static extern void contrib_FaceRecognizer_load_10(IntPtr nativeObj, string filename);
		
		// C++:  void FaceRecognizer::predict(Mat src, int& label, double& confidence)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void contrib_FaceRecognizer_predict_10(IntPtr nativeObj, IntPtr src_nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] label_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] confidence_out);
		
		// C++:  void FaceRecognizer::save(string filename)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void contrib_FaceRecognizer_save_10(IntPtr nativeObj, string filename);
		
		// C++:  void FaceRecognizer::train(vector_Mat src, Mat labels)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void contrib_FaceRecognizer_train_10(IntPtr nativeObj, IntPtr src_mat_nativeObj, IntPtr labels_nativeObj);
		
		// C++:  void FaceRecognizer::update(vector_Mat src, Mat labels)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void contrib_FaceRecognizer_update_10(IntPtr nativeObj, IntPtr src_mat_nativeObj, IntPtr labels_nativeObj);
		
		// native support for java finalize()
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void contrib_FaceRecognizer_delete(IntPtr nativeObj);
