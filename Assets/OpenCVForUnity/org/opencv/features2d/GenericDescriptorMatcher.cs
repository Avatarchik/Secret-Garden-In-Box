...
//	protected readonly IntPtr nativeObj;
	protected GenericDescriptorMatcher(IntPtr addr) { nativeObj = addr; }
 ...
 */
	...
	{
if (queryImage != null)queryImage.ThrowIfDisposed ();
if (queryKeypoints != null)queryKeypoints.ThrowIfDisposed ();
if (trainImage != null)trainImage.ThrowIfDisposed ();
if (trainKeypoints != null)trainKeypoints.ThrowIfDisposed ();
ThrowIfDisposed ();
