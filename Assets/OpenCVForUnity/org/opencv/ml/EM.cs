...
//	}
		...
		// C++:  Vec2d EM::predict(Mat sample, Mat& probs = Mat())
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ml_EM_predict_10(IntPtr nativeObj, IntPtr sample_nativeObj, IntPtr probs_nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void ml_EM_predict_11(IntPtr nativeObj, IntPtr sample_nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
