...
//	/*protected*/internal readonly IntPtr nativeObj;//TODO:@check
		/*protected*/ internal CvANN_MLP_TrainParams(IntPtr addr) { nativeObj = addr; }//TODO:@check
 ...
 */
	...
	public  TermCriteria get_term_crit()
		{
			...
			TermCriteria retVal = new TermCriteria(ml_CvANN_1MLP_1TrainParams_get_1term_1crit_10(nativeObj));
	...
	//
		...
		public  void ml_CvANN_1MLP_1TrainParams_set_1bp_1moment_1scale_10(double bp_moment_scale)
	{
		ThrowIfDisposed ();
	...
	//
		...
		public  double ml_CvANN_1MLP_1TrainParams_get_1rp_1dw0_10()
	{
		ThrowIfDisposed ();
...
//	}
		...
		// C++: TermCriteria CvANN_MLP_TrainParams::term_crit
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern double[] ml_CvANN_1MLP_1TrainParams_get_1term_1crit_10(IntPtr nativeObj);
