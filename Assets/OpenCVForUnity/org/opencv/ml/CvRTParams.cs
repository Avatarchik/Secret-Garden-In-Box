...
public class CvRTParams : CvDTreeParams {
	...
	public  TermCriteria get_term_crit()
	{
		ThrowIfDisposed ();
			...
			#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			TermCriteria retVal = new TermCriteria(ml_CvRTParams_get_1term_1crit_10(nativeObj));
...
//	}
		...
		// C++: TermCriteria CvRTParams::term_crit
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern double[] ml_CvRTParams_get_1term_1crit_10(IntPtr nativeObj);
