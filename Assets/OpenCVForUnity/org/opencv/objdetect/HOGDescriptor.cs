...
//	protected readonly IntPtr nativeObj;
	protected HOGDescriptor(IntPtr addr) { nativeObj = addr; }
...
//	}
		...
		// C++: Size HOGDescriptor::winSize
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void objdetect_HOGDescriptor_get_1winSize_10(IntPtr nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		
		// C++: Size HOGDescriptor::blockSize
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void objdetect_HOGDescriptor_get_1blockSize_10(IntPtr nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		
		// C++: Size HOGDescriptor::blockStride
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void objdetect_HOGDescriptor_get_1blockStride_10(IntPtr nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		
		// C++: Size HOGDescriptor::cellSize
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void objdetect_HOGDescriptor_get_1cellSize_10(IntPtr nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
