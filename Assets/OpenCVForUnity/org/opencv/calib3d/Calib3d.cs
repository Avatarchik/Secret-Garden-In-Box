 ...
 */
				...
				public static bool findCirclesGridDefault (Mat image, Size patternSize, Mat centers, int flags)
				{
						if (image != null)
								image.ThrowIfDisposed ();
						if (centers != null)
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
						bool retVal = calib3d_Calib3d_findCirclesGridDefault_10 (image.nativeObj, patternSize.width, patternSize.height, centers.nativeObj, flags);
				...
				public static bool findCirclesGridDefault (Mat image, Size patternSize, Mat centers)
				{
						if (image != null)
								image.ThrowIfDisposed ();
						if (centers != null)
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
						bool retVal = calib3d_Calib3d_findCirclesGridDefault_11 (image.nativeObj, patternSize.width, patternSize.height, centers.nativeObj);
 ...
 */
				public static Mat findHomography (MatOfPoint2f srcPoints, MatOfPoint2f dstPoints, int method, double ransacReprojThreshold, Mat mask)
				{
						...
						Mat retVal = new Mat (calib3d_Calib3d_findHomography_10 (srcPoints_mat.nativeObj, dstPoints_mat.nativeObj, method, ransacReprojThreshold, mask.nativeObj));
 ...
 */
				public static void solvePnPRansac (MatOfPoint3f objectPoints, MatOfPoint2f imagePoints, Mat cameraMatrix, MatOfDouble distCoeffs, Mat rvec, Mat tvec, bool useExtrinsicGuess, int iterationsCount, float reprojectionError, int minInliersCount, Mat inliers, int flags)
				{
						if (objectPoints != null)
								objectPoints.ThrowIfDisposed ();
						if (imagePoints != null)
						...
						Mat imagePoints_mat = imagePoints;
						Mat distCoeffs_mat = distCoeffs;
						calib3d_Calib3d_solvePnPRansac_10 (objectPoints_mat.nativeObj, imagePoints_mat.nativeObj, cameraMatrix.nativeObj, distCoeffs_mat.nativeObj, rvec.nativeObj, tvec.nativeObj, useExtrinsicGuess, iterationsCount, reprojectionError, minInliersCount, inliers.nativeObj, flags);
 ...
 */
				public static void solvePnPRansac (MatOfPoint3f objectPoints, MatOfPoint2f imagePoints, Mat cameraMatrix, MatOfDouble distCoeffs, Mat rvec, Mat tvec)
				{
						...
						Mat imagePoints_mat = imagePoints;
						Mat distCoeffs_mat = distCoeffs;
						calib3d_Calib3d_solvePnPRansac_11 (objectPoints_mat.nativeObj, imagePoints_mat.nativeObj, cameraMatrix.nativeObj, distCoeffs_mat.nativeObj, rvec.nativeObj, tvec.nativeObj);
 ...
 */
		...
		private static extern void calib3d_Calib3d_RQDecomp3x3_10(IntPtr src_nativeObj, IntPtr mtxR_nativeObj, IntPtr mtxQ_nativeObj, IntPtr Qx_nativeObj, IntPtr Qy_nativeObj, IntPtr Qz_nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void calib3d_Calib3d_RQDecomp3x3_11(IntPtr src_nativeObj, IntPtr mtxR_nativeObj, IntPtr mtxQ_nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		...
		// C++:  void calibrationMatrixValues(Mat cameraMatrix, Size imageSize, double apertureWidth, double apertureHeight, double& fovx, double& fovy, double& focalLength, Point2d& principalPoint, double& aspectRatio)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void calib3d_Calib3d_calibrationMatrixValues_10(IntPtr cameraMatrix_nativeObj, double imageSize_width, double imageSize_height, double apertureWidth, double apertureHeight,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] fovx_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] fovy_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] focalLength_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] principalPoint_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] aspectRatio_out);
		...
		// C++:  bool findCirclesGridDefault(Mat image, Size patternSize, Mat& centers, int flags = CALIB_CB_SYMMETRIC_GRID)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern bool calib3d_Calib3d_findCirclesGridDefault_10(IntPtr image_nativeObj, double patternSize_width, double patternSize_height, IntPtr centers_nativeObj, int flags);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern bool calib3d_Calib3d_findCirclesGridDefault_11(IntPtr image_nativeObj, double patternSize_width, double patternSize_height, IntPtr centers_nativeObj);
		...
		// C++:  Mat findHomography(vector_Point2f srcPoints, vector_Point2f dstPoints, int method = 0, double ransacReprojThreshold = 3, Mat& mask = Mat())
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr calib3d_Calib3d_findHomography_10(IntPtr srcPoints_mat_nativeObj, IntPtr dstPoints_mat_nativeObj, int method, double ransacReprojThreshold, IntPtr mask_nativeObj);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		...
		// C++:  Mat getOptimalNewCameraMatrix(Mat cameraMatrix, Mat distCoeffs, Size imageSize, double alpha, Size newImgSize = Size(), Rect* validPixROI = 0, bool centerPrincipalPoint = false)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr calib3d_Calib3d_getOptimalNewCameraMatrix_10(IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_nativeObj, double imageSize_width, double imageSize_height, double alpha, double newImgSize_width, double newImgSize_height,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] validPixROI_out, bool centerPrincipalPoint);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		...
		// C++:  Rect getValidDisparityROI(Rect roi1, Rect roi2, int minDisparity, int numberOfDisparities, int SADWindowSize)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void calib3d_Calib3d_getValidDisparityROI_10(int roi1_x, int roi1_y, int roi1_width, int roi1_height, int roi2_x, int roi2_y, int roi2_width, int roi2_height, int minDisparity, int numberOfDisparities, int SADWindowSize,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] vals);
		...
		// C++:  void solvePnPRansac(vector_Point3f objectPoints, vector_Point2f imagePoints, Mat cameraMatrix, vector_double distCoeffs, Mat& rvec, Mat& tvec, bool useExtrinsicGuess = false, int iterationsCount = 100, float reprojectionError = 8.0, int minInliersCount = 100, Mat& inliers = Mat(), int flags = ITERATIVE)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void calib3d_Calib3d_solvePnPRansac_10(IntPtr objectPoints_mat_nativeObj, IntPtr imagePoints_mat_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_mat_nativeObj, IntPtr rvec_nativeObj, IntPtr tvec_nativeObj, bool useExtrinsicGuess, int iterationsCount, float reprojectionError, int minInliersCount, IntPtr inliers_nativeObj, int flags);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void calib3d_Calib3d_solvePnPRansac_11(IntPtr objectPoints_mat_nativeObj, IntPtr imagePoints_mat_nativeObj, IntPtr cameraMatrix_nativeObj, IntPtr distCoeffs_mat_nativeObj, IntPtr rvec_nativeObj, IntPtr tvec_nativeObj);
		
		// C++:  double stereoCalibrate(vector_Mat objectPoints, vector_Mat imagePoints1, vector_Mat imagePoints2, Mat& cameraMatrix1, Mat& distCoeffs1, Mat& cameraMatrix2, Mat& distCoeffs2, Size imageSize, Mat& R, Mat& T, Mat& E, Mat& F, TermCriteria criteria = TermCriteria(TermCriteria::COUNT+TermCriteria::EPS, 30, 1e-6), int flags = CALIB_FIX_INTRINSIC)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern double calib3d_Calib3d_stereoCalibrate_10(IntPtr objectPoints_mat_nativeObj, IntPtr imagePoints1_mat_nativeObj, IntPtr imagePoints2_mat_nativeObj, IntPtr cameraMatrix1_nativeObj, IntPtr distCoeffs1_nativeObj, IntPtr cameraMatrix2_nativeObj, IntPtr distCoeffs2_nativeObj, double imageSize_width, double imageSize_height, IntPtr R_nativeObj, IntPtr T_nativeObj, IntPtr E_nativeObj, IntPtr F_nativeObj, int criteria_type, int criteria_maxCount, double criteria_epsilon, int flags);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
