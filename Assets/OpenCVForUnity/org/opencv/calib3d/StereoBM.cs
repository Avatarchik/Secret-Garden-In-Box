 ...
 */
				...
				{
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			nativeObj = calib3d_StereoBM_StereoBM_10();
 ...
 */
				...
				{
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			nativeObj = calib3d_StereoBM_StereoBM_11(preset, ndisparities, SADWindowSize);
 ...
 */
				...
				{
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			nativeObj = calib3d_StereoBM_StereoBM_12(preset);
 ...
 */
				public  void compute (Mat left, Mat right, Mat disparity, int disptype)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			calib3d_StereoBM_compute_10(nativeObj, left.nativeObj, right.nativeObj, disparity.nativeObj, disptype);
 ...
 */
				public  void compute (Mat left, Mat right, Mat disparity)
				{
						...
						#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			calib3d_StereoBM_compute_11(nativeObj, left.nativeObj, right.nativeObj, disparity.nativeObj);
...
//	}
		...
		private static extern IntPtr calib3d_StereoBM_StereoBM_10();
		
		// C++:   StereoBM::StereoBM(int preset, int ndisparities = 0, int SADWindowSize = 21)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr calib3d_StereoBM_StereoBM_11(int preset, int ndisparities, int SADWindowSize);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr calib3d_StereoBM_StereoBM_12(int preset);
		
		// C++:  void StereoBM::operator ()(Mat left, Mat right, Mat& disparity, int disptype = CV_16S)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void calib3d_StereoBM_compute_10(IntPtr nativeObj, IntPtr left_nativeObj, IntPtr right_nativeObj, IntPtr disparity_nativeObj, int disptype);
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void calib3d_StereoBM_compute_11(IntPtr nativeObj, IntPtr left_nativeObj, IntPtr right_nativeObj, IntPtr disparity_nativeObj);
