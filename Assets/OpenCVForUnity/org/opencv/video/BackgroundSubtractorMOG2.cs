 ...
 */
		...
		protected override void Dispose (bool disposing)
		{
			...
			return;
				...
				protected BackgroundSubtractorMOG2 (IntPtr addr) : 
			#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
			base(addr)
			#else
			base(IntPtr.Zero)
 ...
 */
	...
	:
				#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
		base( video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_10() )
				#else
				base(IntPtr.Zero)
				#endif
				{
 ...
 */
	...
	:
				#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
		                                                             base( video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_11(history, varThreshold, bShadowDetection) )
				#else
				base(IntPtr.Zero)
				#endif
				{
 ...
 */
	...
	:
				#if UNITY_PRO_LICENSE || ((UNITY_ANDROID || UNITY_IPHONE) && !UNITY_EDITOR)
		                                                             base( video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_12(history, varThreshold) )
				#else
				base(IntPtr.Zero)
				#endif
				{
...
//	}
		...
		private static extern IntPtr video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_10 ();
		
		// C++:   BackgroundSubtractorMOG2::BackgroundSubtractorMOG2(int history, float varThreshold, bool bShadowDetection = true)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_11 (int history, float varThreshold, bool bShadowDetection);
		
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern IntPtr video_BackgroundSubtractorMOG2_BackgroundSubtractorMOG2_12 (int history, float varThreshold);
