...
//	}
		...
		// C++:  void DeviceInfo::queryMemory(size_t& totalMemory, size_t& freeMemory)
		[DllImport("__Internal", CallingConvention = CallingConvention.Cdecl)]
		private static extern void gpu_DeviceInfo_queryMemory_10(IntPtr nativeObj,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] totalMemory_out,[In, Out, MarshalAs(UnmanagedType.LPArray)] double[] freeMemory_out);
