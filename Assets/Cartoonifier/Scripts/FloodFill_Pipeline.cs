...
public class FloodFill_Pipeline : BasicPipeline {

    public FloodFill_Pipeline(int rows, int cols) : base(rows, cols)
    {
        //HandleOnInit(rows, cols);
    }

    public Texture2D HandleOnFloodFill(Vector2 position)
    {
        ...
        Core.add(inputMat, new Scalar(0, 0, 255, 255), outputMat, mask);
